...
class FormComenzar(Form):
    ...
    def run(self):
        ...
        texto = fuente.render("GAME OVER",0,BLACK)

        player_1 = Player(      )

        enemigo_walk = Enemigo_walker( path_stay=ew_2["stay"]["path"], col_stay=ew_2["stay"]["col"],rows_stay=ew_2["stay"]["rows"],flip_stay=ew_2["stay"]["flip"], 
