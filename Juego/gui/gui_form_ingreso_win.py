...
class FormIngresoWin(Form):
    ...
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton4 = Button_con_atajo(master=self,x=1000,y=150,w=400,h=300,color_background=None,color_border=None,text=None,font="Verdana",font_size=30,font_color=BLACK,on_click=self.on_click_boton1,on_click_param="you_win",on_keydown="you_win",tecla=2)
