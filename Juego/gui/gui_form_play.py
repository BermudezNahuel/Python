...
class FormPlay(Form):
    ...
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.menu_atajo = Button_con_atajo(master=self,x=0,y=0,w=0,h=0,color_background=(255,0,0),color_border=(255,0,255),on_click=self.on_click_boton1,on_click_param="menu",on_keydown="menu",text="ABRIR B",font="Verdana",font_size=30,font_color=(0,255,0),tecla=0)
        self.lista_widget = [self.salir,self.menu,self.menu_atajo]
    ...
    def cargar_atributos(self):
        ...
        if self.reinicio:
            ...
            self.fuente_score = pygame.font.SysFont("Verdana",30)
    ...
    def update(self, lista_eventos,delta_ms,keys):
        ...
        self.player.update(delta_ms,self.plataformas,bala_enemigo=self.lista_balas_enemy)
        ...
        self.barra_score.update(self.player)
        self.barra_tiempo.update(delta_ms=delta_ms,boss=self.enemigo_boss)
        self.barra_proyectiles.update(lista_proyectiles=self.lista_balas_player)
    ...
    def draw(self):
        ...
        self.barra_score.draw(screen=self.master_surface)
        self.barra_tiempo.draw(screen=self.master_surface)
        self.barra_proyectiles.draw(screen=self.master_surface)
