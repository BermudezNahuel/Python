...
class FormInicio(Form):
    '''
    Este es el segundo formulario al que se accede y muestra botones para comenzar a jugar, para entrar a las configuraciones del juego y para poder visualizar los puntajes maximos
    '''
