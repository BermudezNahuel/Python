...
class FormPlay(Form):
    ...
    def cargar_atributos(self):
        ...
        if self.reinicio:
            ...
            self.fuente_score = pygame.font.SysFont("fixedsys",30)
    ...
    def update(self, lista_eventos,delta_ms,keys):
        ...
        '''
        #self.manager_score.update(player=self.player,delta_ms=delta_ms,boss=self.enemigo_boss)
    ...
    def draw(self):
        ...
        #self.manager_score.draw(screen=self.master_surface)
