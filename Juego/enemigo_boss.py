...
class Enemigo_boss(Enemigo_master):
    def __init__(self,path_stay,col_stay,rows_stay,flip_stay_l,flip_stay_r,scale_stay,path_hit,col_hit,rows_hit,flip_hit_r,flip_hit_l,scale_hit,x=400,y=0,direction=DIRECTION_R,gravity=14, frame_rate_ms=75, move_rate_ms=50) -> None:
