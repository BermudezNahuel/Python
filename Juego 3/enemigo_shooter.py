...
class Enemigo_shooter(Enemigo_master):
    ...
    def __init__(self,x,y,direction,path,columnas,filas,flip,gravity=10,frame_rate_ms=150,move_rate_ms=50) -> None:
        ...
        self.stay_r = Auxiliar.getSurfaceFromSpriteSheet(path,columnas,filas,flip)
        self.stay_l = Auxiliar.getSurfaceFromSpriteSheet(path,columnas,filas,flip)
        ...
        self.disparo_collition_rect_l = pygame.Rect(x-300,y+10,300,GROUND_COLLIDE_H)
        self.disparo_collition_rect_r = pygame.Rect(x,y+10,300,GROUND_COLLIDE_H)
