...
class Crear_json_1:
   ...
   def update(self):
         ...
         self.data["nivel"].append({"imagen_fondo":{"x":ANCHO_VENTANA,
                                                "y":ALTO_VENTANA,
                                                "path": "C:/Users/Nahuel/Documents/TUP/programacion-y-laboratorio-1/images/images/locations/set_bg_01/mountain/all.png"
                                                }
                                 }
         )
         ...
         with open('programacion-y-laboratorio-1\Juego 3\data.json', 'w') as file:
