...
class Lista_walkers:
    def __init__(self,cantidad=lew["cantidad"],tiempo_spawn=lew["tiempo_spawn"]) -> None:
        self.cantidad = cantidad
        self.lista_general = self.crear_enemigos()# En esta lista se encuentran los enemigos no nacidos
    ...
    def crear_enemigos(self):
        return [Enemigo_walker() for i in range(self.cantidad)] #Genera una lista en una sola lista usando un for
